...
static unsigned char is_low_power_cnt=0;
...
//	int i,u,d;
    unsigned char temp=0;
   	temp=(IORD(ADGETNEW2_0_BASE,0)&0x00ff);   //读电池电压
	if(temp < 196)
	{
		return 1;
    }
