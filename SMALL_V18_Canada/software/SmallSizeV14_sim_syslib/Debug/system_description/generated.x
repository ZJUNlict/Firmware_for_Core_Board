 ...
 *
 * Generated: 2018-07-14 16:33:58.544
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x01001800, LENGTH = 32
    sdram_0_UNUSED : ORIGIN = 0x00800000, LENGTH = 32
    sdram_0 : ORIGIN = 0x00800020, LENGTH = 8388576
    epcs_flash_controller_0 : ORIGIN = 0x01001820, LENGTH = 2016
}

    /* Define symbols for each memory base-address */
 __alt_mem_sdram_0 = 0x00800000 ;
 __alt_mem_epcs_flash_controller_0 = 0x01001800 ;
...
SECTIONS
{
    ...
    .text :
    {
        ...
        *(.dynamic)
        ...
        KEEP (*(.jcr))
        . = ALIGN(32 / 8);
    } >  sdram_0 =0x3a880100 /* NOP on Nios2 (big endian) */
...
PROVIDE( __alt_heap_limit    = 0x01000000 );
